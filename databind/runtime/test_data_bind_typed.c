...
static const DataBindTypedField TEST_PACKET_FIELDS[] = {
    {.name = "code",
    ...
    {.name = "name",
     ...
     .flags = DATA_BIND_TYPED_FIELD_VAR_DATA}};

static const DataBindTypedType TEST_PACKET_TYPE = {
    .name = "Packet",
...
DATA_BIND_TYPED_VEC_DEFINE(test_u32_vec_t, uint32_t)

typedef struct TestValues {
  test_u32_vec_t values;
} TestValues;

static const DataBindTypedField TEST_VALUES_FIELDS[] = {{
    .name = "values",
    .kind = DATA_BIND_TYPED_LIST,
    .wire_kind = DATA_BIND_TYPED_LIST,
    .offset = offsetof(TestValues, values),
    .element_kind = DATA_BIND_TYPED_U32,
    .element_wire_kind = DATA_BIND_TYPED_U32,
    .element_size = sizeof(uint32_t),
}};

static const DataBindTypedType TEST_VALUES_TYPE = {
    .name = "Values",
...
static const DataBindTypedField TEST_FIXED_VALUES_FIELDS[] = {{
    .name = "values",
    .kind = DATA_BIND_TYPED_FIXED_ARRAY,
    .wire_kind = DATA_BIND_TYPED_FIXED_ARRAY,
    .offset = offsetof(TestFixedValues, values),
    .element_kind = DATA_BIND_TYPED_U16,
    .element_wire_kind = DATA_BIND_TYPED_U16,
...
static const DataBindTypedType TEST_FIXED_VALUES_TYPE = {
    .name = "FixedValues",
...
static const DataBindTypedField TEST_TEXT_FIELDS[] = {{
    .name = "text",
    .kind = DATA_BIND_TYPED_STRING,
    .wire_kind = DATA_BIND_TYPED_STRING,
...
static const DataBindTypedType TEST_TEXT_TYPE = {
    .name = "Text",
...
static const DataBindTypedField TEST_WIDE_ENUM_FIELDS[] = {{
    .name = "value",
    .kind = DATA_BIND_TYPED_ENUM,
    .wire_kind = DATA_BIND_TYPED_U64,
...
static const DataBindTypedType TEST_WIDE_ENUM_TYPE = {
    .name = "WideRecord",
...
static const DataBindTypedField TEST_FLOAT32_FIELDS[] = {{
    .name = "value",
    .kind = DATA_BIND_TYPED_F32,
    .wire_kind = DATA_BIND_TYPED_F32,
    .offset = offsetof(TestFloat32, value),
}};

static const DataBindTypedType TEST_FLOAT32_TYPE = {
    .name = "FloatRecord",
...
static const DataBindTypedField TEST_FLOAT64_FIELDS[] = {{
    .name = "value",
    .kind = DATA_BIND_TYPED_F64,
    .wire_kind = DATA_BIND_TYPED_F64,
    .offset = offsetof(TestFloat64, value),
}};

static const DataBindTypedType TEST_FLOAT64_TYPE = {
    .name = "DoubleRecord",
...
static const DataBindTypedField TEST_BYTES_FIELDS[] = {{
    .name = "value",
...
static const DataBindTypedType TEST_BYTES_TYPE = {
    .name = "BytesRecord",
...
DATA_BIND_TYPED_VEC_DEFINE(macro_u32_vec_t, uint32_t)
...
DATA_BIND_TYPED_DEFINE_STRUCT_WITH_PRESENCE(
    MACRO_ORDER_BINDING, MacroOrder, "MacroOrder", presence,
    DATA_BIND_TYPED_FIELD(MacroOrder, order_id, "id", DATA_BIND_TYPED_U32, DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_FIELD(MacroOrder, note, "note", DATA_BIND_TYPED_STRING, DATA_BIND_TYPED_OPTIONAL(0)),
    DATA_BIND_TYPED_LIST_FIELD(MacroOrder, values, "values", DATA_BIND_TYPED_U32, uint32_t, NULL,
...
DATA_BIND_TYPED_DEFINE_STRUCT(
    ...
    DATA_BIND_TYPED_FIELD(InvalidMacroOrder, note, "note", DATA_BIND_TYPED_STRING,
                    DATA_BIND_TYPED_OPTIONAL(0)));
...
DATA_BIND_TYPED_DEFINE_STRUCT(
    ...
    DATA_BIND_TYPED_FIELD(MacroChild, code, "code", DATA_BIND_TYPED_U16, DATA_BIND_TYPED_REQUIRED));

DATA_BIND_TYPED_VEC_DEFINE(macro_child_vec_t, MacroChild)
...
DATA_BIND_TYPED_VEC_DEFINE(macro_child_map_vec_t, MacroChildMapEntry)
...
DATA_BIND_TYPED_DEFINE_STRUCT(
    ...
    DATA_BIND_TYPED_OBJECT_FIELD(MacroCollections, child, "child", &MACRO_CHILD_BINDING,
                           DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_FIXED_ARRAY_FIELD(MacroCollections, fixed_values, "fixed_values", DATA_BIND_TYPED_U16,
                                uint16_t, NULL, DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_FIXED_BYTES_FIELD(MacroCollections, fixed_bytes, "fixed_bytes",
                                DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_LIST_FIELD(MacroCollections, children, "children", DATA_BIND_TYPED_OBJECT, MacroChild,
                         &MACRO_CHILD_BINDING, DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_SET_FIELD(MacroCollections, unique_children, "unique_children", DATA_BIND_TYPED_OBJECT,
                        MacroChild, &MACRO_CHILD_BINDING, DATA_BIND_TYPED_REQUIRED),
    DATA_BIND_TYPED_MAP_FIELD(MacroCollections, children_by_name, "children_by_name",
                        MacroChildMapEntry, key, value, DATA_BIND_TYPED_OBJECT, &MACRO_CHILD_BINDING,
                        DATA_BIND_TYPED_REQUIRED));
...
DATA_BIND_TYPED_DEFINE_STRUCT_EX(
    MACRO_WIRE_BINDING, MacroWire, "MacroWire", 4u, 0u, 0u, 0,
    DATA_BIND_TYPED_FIELD_EX(MacroWire, id, "id", DATA_BIND_TYPED_U32, DATA_BIND_TYPED_U32, DATA_BIND_TYPED_BOOL,
                       DATA_BIND_TYPED_BOOL, 0u, 0u, NULL, 0u, 0u, 0u, DATA_BIND_TYPED_BOOL,
                       DATA_BIND_TYPED_BOOL, NULL, 0u, 4u, 0u, DATA_BIND_TYPED_FIELD_WIRE_OFFSET));
...
static const DataBindTypedDescriptor MACRO_WIRE_DESCRIPTOR =
    DATA_BIND_TYPED_DESCRIPTOR_INIT(&MACRO_WIRE_BINDING, &MACRO_WIRE_CMETA_DATA);
...
spec("typed DataBind binary") {
  it("round-trips an optional big-endian owning struct directly") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_PACKET_TYPE, &source, &error), DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_PACKET_TYPE, &decoded, &error), DATA_BIND_OK);
    source.presence[0] = 1;
    ...
    if (codec != NULL && source.name != NULL) {
      check_equal(data_bind_typed_validate_schema(codec, "Packet", &TEST_PACKET_TYPE, &error),
                   DATA_BIND_OK);
      check_equal(data_bind_typed_serialize_binary(&TEST_PACKET_TYPE, &source, &wire, &wire_len, &error),
                   DATA_BIND_OK);
      check_equal(wire_len, sizeof(expected));
      check_equal(wire, expected, sizeof(expected));
      check_equal(data_bind_typed_parse(codec, "Packet", &TEST_PACKET_TYPE, "bin", wire, wire_len, 0,
                                   &decoded, &error),
                   DATA_BIND_OK);
    ...
    data_bind_typed_clear(&TEST_PACKET_TYPE, &decoded);
    data_bind_typed_clear(&TEST_PACKET_TYPE, &source);
  ...
  it("rejects a descriptor whose byte order differs from the schema") {
    ...
    DataBindError error = DATA_BIND_ERROR_INIT;
    DataBind *codec = NULL;
    DataBindTypedType wrong_order = TEST_PACKET_TYPE;

    wrong_order.wire_big_endian = 0;
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    if (codec != NULL)
      check_equal(data_bind_typed_validate_schema(codec, "Packet", &wrong_order, &error),
  ...
  it("preserves the owning struct when direct decoding is truncated") {
    ...
    check_equal(data_bind_typed_init(&TEST_PACKET_TYPE, &packet, &error), DATA_BIND_OK);
    packet.presence[0] = 1;
    packet.code = 9;
    packet.count = 11;
    ...
    if (packet.name != NULL) {
      check_equal(data_bind_typed_parse_binary(&TEST_PACKET_TYPE, truncated, sizeof(truncated), &packet,
                                          &error),
                   DATA_BIND_ERR_PARSE);
    ...
    data_bind_typed_clear(&TEST_PACKET_TYPE, &packet);
  }
  ...
  it("rejects trailing bytes without replacing the destination object") {
    ...
    check_not_null(packet.name);
    if (packet.name != NULL) {
      check_equal(data_bind_typed_parse_binary(&TEST_PACKET_TYPE, wire, sizeof(wire), &packet, &error),
                   DATA_BIND_ERR_PARSE);
      check_equal(packet.count, 11u);
      check_equal(packet.name, "stable");
    }
  ...
  it("round-trips uint64 enum values without narrowing") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_WIDE_ENUM_TYPE, &value, &error), DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_WIDE_ENUM_TYPE, &decoded, &error), DATA_BIND_OK);
    if (codec != NULL) {
      check_equal(data_bind_typed_parse(codec, "WideRecord", &TEST_WIDE_ENUM_TYPE, "json", json,
                                   sizeof(json) - 1, 0, &value, &error),
                   DATA_BIND_OK);
      check(value.value == UINT64_MAX);
      check_equal(data_bind_typed_serialize_binary(&TEST_WIDE_ENUM_TYPE, &value, &wire, &wire_len,
                                              &error),
                   DATA_BIND_OK);
      check_equal(wire_len, sizeof(expected));
      check_equal(wire, expected, sizeof(expected));
      check_equal(data_bind_typed_parse_binary(&TEST_WIDE_ENUM_TYPE, wire, wire_len, &decoded, &error),
                   DATA_BIND_OK);
      check(decoded.value == UINT64_MAX);
      check_equal(data_bind_typed_serialize(codec, "WideRecord", &TEST_WIDE_ENUM_TYPE, &value, "json",
                                      &encoded_json, &json_len, &error),
                   DATA_BIND_OK);
      check_equal(encoded_json, "{\"value\":18446744073709551615}");
    }
    data_bind_typed_serialized_free(encoded_json);
    data_bind_typed_serialized_free(wire);
    data_bind_typed_clear(&TEST_WIDE_ENUM_TYPE, &decoded);
    data_bind_typed_clear(&TEST_WIDE_ENUM_TYPE, &value);
    data_bind_free(codec);
  }
  ...
  it("combines uint64 flags above INT64_MAX") {
    ...
    DataBindError error = DATA_BIND_ERROR_INIT;
    DataBind *codec = NULL;
    DataBindTypedType flags_type = TEST_WIDE_ENUM_TYPE;
    TestWideEnum value;

    flags_type.name = "WideFlagsRecord";
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&flags_type, &value, &error), DATA_BIND_OK);
    if (codec != NULL) {
      check_equal(data_bind_typed_parse(codec, "WideFlagsRecord", &flags_type, "json", json,
                                   sizeof(json) - 1, 0, &value, &error),
                   DATA_BIND_OK);
      check(value.value == (UINT64_C(1) | (UINT64_C(1) << 63)));
    }
    data_bind_typed_clear(&flags_type, &value);
    data_bind_free(codec);
  }
  ...
  it("rejects finite doubles outside the float32 range") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_FLOAT32_TYPE, &value, &error), DATA_BIND_OK);
    value.value = 1.0f;
    if (codec != NULL) {
      check_equal(data_bind_typed_parse(codec, "FloatRecord", &TEST_FLOAT32_TYPE, "json", json,
                                   sizeof(json) - 1, 0, &value, &error),
                   DATA_BIND_ERR_TYPE_MISMATCH);
      check_within(value.value, 1.0f, 0.0f);
    }
    data_bind_typed_clear(&TEST_FLOAT32_TYPE, &value);
    data_bind_free(codec);
  }
  ...
  it("rejects invalid UTF-8 bytes before creating JSON strings") {
    ...
    check_equal(data_bind_typed_init(&TEST_BYTES_TYPE, &bytes, &error), DATA_BIND_OK);
    ...
    if (tbe_bytes_t_data(&bytes.value) != NULL) {
      ...
      json = data_bind_typed_to_json(&TEST_BYTES_TYPE, &bytes, &error);
      check_null(json);
      check_equal(error.code, DATA_BIND_ERR_TYPE_MISMATCH);
      data_bind_typed_json_free(&json);
    }
    data_bind_typed_clear(&TEST_BYTES_TYPE, &bytes);
  }
  ...
  it("converts dynamic values transactionally into initialized owning structs") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_TEXT_TYPE, &text, &error), DATA_BIND_OK);
    ...
    if (codec != NULL && text.text != NULL) {
      ...
      check_equal(data_bind_parse_json(codec, "Number", invalid_json, sizeof(invalid_json) - 1,
                                        &invalid, &error),
                   DATA_BIND_OK);
      check_equal(data_bind_typed_from_value(&TEST_TEXT_TYPE, valid, &text, &error), DATA_BIND_OK);
      check_equal(text.text, "replacement");
      check_equal(data_bind_typed_from_value(&TEST_TEXT_TYPE, invalid, &text, &error),
                   DATA_BIND_ERR_TYPE_MISMATCH);
      check_equal(text.text, "replacement");
    }
    data_bind_value_free(invalid);
    data_bind_value_free(valid);
    data_bind_typed_clear(&TEST_TEXT_TYPE, &text);
    data_bind_free(codec);
  }
  ...
  it("rejects invalid UTF-8 strings non-finite numbers and invalid map keys in JSON") {
    ...
    check_not_null(text.text);
    if (text.text != NULL) {
      json = data_bind_typed_to_json(&TEST_TEXT_TYPE, &text, &error);
      check_null(json);
      check_equal(error.code, DATA_BIND_ERR_TYPE_MISMATCH);
    }
    data_bind_typed_json_free(&json);
    ...
    check_equal(data_bind_typed_init(&TEST_FLOAT32_TYPE, &number, &error), DATA_BIND_OK);
    number.value = NAN;
    json = data_bind_typed_to_json(&TEST_FLOAT32_TYPE, &number, &error);
    check_null(json);
    check_equal(error.code, DATA_BIND_ERR_TYPE_MISMATCH);
    data_bind_typed_json_free(&json);
    data_bind_typed_clear(&TEST_FLOAT32_TYPE, &number);

    check_equal(data_bind_typed_init(&TEST_FLOAT64_TYPE, &double_number, &error), DATA_BIND_OK);
    double_number.value = INFINITY;
    json = data_bind_typed_to_json(&TEST_FLOAT64_TYPE, &double_number, &error);
    check_null(json);
    check_equal(error.code, DATA_BIND_ERR_TYPE_MISMATCH);
    data_bind_typed_json_free(&json);
    data_bind_typed_clear(&TEST_FLOAT64_TYPE, &double_number);

    check_equal(DATA_BIND_TYPED_BIND_INIT(MACRO_COLLECTIONS_BINDING, &collections, &error),
                 DATA_BIND_OK);
    {
    ...
    if (macro_child_map_vec_t_size(&collections.children_by_name) == 1u) {
      ...
      check_not_null(entry->key);
      if (entry->key != NULL) {
        json = data_bind_typed_to_json(&MACRO_COLLECTIONS_BINDING, &collections, &error);
        check_null(json);
        check_equal(error.code, DATA_BIND_ERR_TYPE_MISMATCH);
      }
      data_bind_typed_json_free(&json);
    }
    DATA_BIND_TYPED_BIND_CLEAR(MACRO_COLLECTIONS_BINDING, &collections);
  }

  it("validates the fixed wire layout before writing output") {
    DataBindError error = DATA_BIND_ERROR_INIT;
    DataBindTypedField fields[3];
    DataBindTypedType invalid = TEST_PACKET_TYPE;
    TestPacket packet;
    uint8_t output[32];
    uint8_t expected[32];
    size_t out_len = 99;
    ...
    check_equal(data_bind_typed_serialize_binary_into(&invalid, &packet, output, sizeof(output),
                                                 &out_len, &error),
                 DATA_BIND_ERR_SCHEMA);
  ...
  it("keeps variable collections compatible through the typed struct API") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_VALUES_TYPE, &values, &error), DATA_BIND_OK);
    if (codec != NULL) {
      const uint32_t *items;
      check_equal(data_bind_typed_validate_schema(codec, "Values", &TEST_VALUES_TYPE, &error),
                   DATA_BIND_OK);
      check_equal(data_bind_typed_parse(codec, "Values", &TEST_VALUES_TYPE, "bin", wire, sizeof(wire),
                                   0, &values, &error),
                   DATA_BIND_OK);
    ...
    data_bind_typed_clear(&TEST_VALUES_TYPE, &values);
    data_bind_free(codec);
  }
  ...
  it("matches and decodes fixed array schema fields") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(data_bind_typed_init(&TEST_FIXED_VALUES_TYPE, &values, &error), DATA_BIND_OK);
    if (codec != NULL) {
      check_equal(data_bind_typed_validate_schema(codec, "FixedValues", &TEST_FIXED_VALUES_TYPE,
                                             &error),
                   DATA_BIND_OK);
      check_equal(data_bind_typed_parse(codec, "FixedValues", &TEST_FIXED_VALUES_TYPE, "bin", wire,
                                   sizeof(wire), 0, &values, &error),
                   DATA_BIND_OK);
      check_equal(values.values[0], UINT16_C(0x1234));
      check_equal(values.values[1], UINT16_C(0xabcd));
    }
    data_bind_typed_clear(&TEST_FIXED_VALUES_TYPE, &values);
    data_bind_free(codec);
  }
  ...
  it("directly decodes a variable-data-only record with a zero fixed block") {
    ...
    check_equal(data_bind_typed_init(&TEST_TEXT_TYPE, &text, &error), DATA_BIND_OK);
    check_equal(data_bind_typed_parse_binary(&TEST_TEXT_TYPE, wire, sizeof(wire), &text, &error),
                 DATA_BIND_OK);
  ...
  it("serializes typed records with schema field mappings") {
    ...
    check_not_null(text.text);
    if (codec != NULL && text.text != NULL) {
      check_equal(data_bind_typed_serialize(codec, "Text", &TEST_TEXT_TYPE, &text, "json", &json,
                                      &json_len, &error),
                   DATA_BIND_OK);
  ...
  it("binds an existing C struct through header-only macros") {
    ...
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1, &codec, &error),
                 DATA_BIND_OK);
    check_equal(DATA_BIND_TYPED_BIND_INIT(MACRO_ORDER_BINDING, &order, &error), DATA_BIND_OK);
    if (codec != NULL) {
      check_equal(DATA_BIND_TYPED_BIND_PARSE(codec, MACRO_ORDER_BINDING, "json", json,
      ...
      check_equal(DATA_BIND_TYPED_BIND_SERIALIZE(codec, MACRO_ORDER_BINDING, &order, "json", &mapped,
                                           &mapped_len, &error),
                   DATA_BIND_OK);
      check_equal(mapped, "{\"orderId\":42,\"note\":\"macro\",\"values\":[7,9]}");
      check_equal(mapped_len, strlen(mapped));
    }
    data_bind_typed_serialized_free(mapped);
    DATA_BIND_TYPED_BIND_CLEAR(MACRO_ORDER_BINDING, &order);
    data_bind_free(codec);
  }
  ...
  it("rejects an optional macro field without a presence bitmap") {
    ...
    check_equal(DATA_BIND_TYPED_BIND_INIT(INVALID_MACRO_ORDER_BINDING, &order, &error),
                 DATA_BIND_ERR_SCHEMA);
  ...
  it("validates all composite macro field families") {
    ...
    check_equal(data_bind_typed_validate_descriptor(&MACRO_COLLECTIONS_BINDING, &error),
                 DATA_BIND_OK);
    check_equal(DATA_BIND_TYPED_BIND_INIT(MACRO_COLLECTIONS_BINDING, &collections, &error),
                 DATA_BIND_OK);
  ...
  it("uses explicit macro metadata for direct binary layout") {
    ...
    check_equal(data_bind_typed_serialize_binary(&MACRO_WIRE_BINDING, &wire, &encoded, &encoded_len,
                                            &error),
                 DATA_BIND_OK);
  ...
  it("queries binary capacity and reports a distinct short-buffer status") {
    ...
    check_equal(data_bind_typed_serialize_binary_into(&MACRO_WIRE_BINDING, &wire, NULL, 0, &required,
                                                 &error),
                 DATA_BIND_ERR_BUFFER_TOO_SMALL);
    check_equal(required, sizeof(output));
    check_equal(data_bind_typed_serialize_binary_into(&MACRO_WIRE_BINDING, &wire, output,
  ...
  it("validates versioned descriptors and enum-based format APIs") {
    ...
    char *encoded = NULL;
    size_t encoded_len = 0;
    DataBindTypedDescriptor incompatible = MACRO_WIRE_DESCRIPTOR;

    check_equal(data_bind_typed_descriptor_validate(&MACRO_WIRE_DESCRIPTOR, &error),
                 DATA_BIND_OK);
    incompatible.abi_version++;
    check_equal(data_bind_typed_descriptor_validate(&incompatible, &error), DATA_BIND_ERR_SCHEMA);
    check_equal(data_bind_create_from_text(schema, sizeof(schema) - 1u, &codec, &error),
                 DATA_BIND_OK);
    if (codec != NULL) {
      check_equal(data_bind_typed_descriptor_parse(codec, "MacroWire",
                                              &MACRO_WIRE_DESCRIPTOR,
                                              DATA_BIND_FORMAT_JSON, json, sizeof(json) - 1u, 0,
                                              &wire, &error),
                   DATA_BIND_OK);
      check_equal(wire.id, 7u);
      check_equal(data_bind_typed_descriptor_serialize(codec, "MacroWire",
