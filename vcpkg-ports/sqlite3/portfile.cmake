...
vcpkg_check_features(OUT_FEATURE_OPTIONS FEATURE_OPTIONS
    FEATURES
        ...
        vdbe                SQLITE_ENABLE_VDBE_BRIDGE
        zlib                WITH_ZLIB
...
file(COPY "${CMAKE_CURRENT_LIST_DIR}/sqlite3_vdbe_bridge.c" DESTINATION "${SOURCE_PATH}")
file(COPY "${CMAKE_CURRENT_LIST_DIR}/sqlite3_vdbe.h" DESTINATION "${SOURCE_PATH}")
