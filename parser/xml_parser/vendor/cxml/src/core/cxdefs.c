...
static cxml_source_location empty_source_location(void) {
    cxml_source_location source = {0u, 0u, 0u};
    return source;
}
...
void cxml_elem_node_init(cxml_elem_node *elem) {
    ...
    elem->parent = NULL;
    elem->pos = 0;
    elem->source = empty_source_location();
}
...
void cxml_root_node_init(cxml_root_node* root_node){
    ...
    root_node->pos = 0;
    root_node->source = empty_source_location();
...
void cxml_pi_node_init(cxml_pi_node* pi){
    ...
    pi->parent = NULL;
    pi->pos = 0;
    pi->source = empty_source_location();
}
...
void cxml_text_node_init(cxml_text_node *text) {
    ...
    text->is_cdata = 0;
    text->pos = 0;
    text->source = empty_source_location();
}
...
void cxml_attr_node_init(cxml_attr_node* cx_attr){
    ...
    cx_attr->parent = NULL;
    cx_attr->pos = 0;
    cx_attr->source = empty_source_location();
...
void cxml_ns_node_init(cxml_ns_node* cx_ns){
    ...
    cx_ns->is_global = 0;
    cx_ns->pos = 0;
    cx_ns->source = empty_source_location();
}
...
void cxml_comm_node_init(cxml_comm_node *cx_comment) {
    ...
    cx_comment->pos = 0;
    cx_comment->source = empty_source_location();
}
