...
Package version `2.0.1` is built against and depends on `Salts.Native 1.1.0`.
...
Consumers restore `SaltsUtils.Native 2.0.1` and its exact `Salts.Native 1.1.0` dependency,
...
SaltsUtils SDK:
    ...
    export SALTS_UTILS_ROOT=<nuget>/saltsutils.native/2.0.1/sdk/linux-x64
