...
Package version `3.1.0` is built against and depends on `Salts.Native 1.3.0`.
...
Consumers restore `SaltsUtils.Native 3.1.0` and its exact `Salts.Native 1.3.0` dependency,
...
SaltsUtils SDK:
    ...
    export SALTS_UTILS_ROOT=<nuget>/saltsutils.native/3.1.0/sdk/linux-x64
